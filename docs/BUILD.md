...
> hardware this software interoperates with. Cénit contains no WHOOP code, firmware, or assets. All
...
Cénit connects over CoreBluetooth (`Cenit/BLE/BLEManager.swift`). The central manager is created
on the main queue:
