...
`displayXL` 54/700 −1.9 (hero) · `displayL` 30/700 · `displayM` 40/700 · `valorL` 20/700 tabular ·
...
dock: `dockSide`=16, `dockBottom`=14.
...
| `LiquidSignalOrb` | label · caption · progress 0–1 · icon · state ok/atención (· action) |
...
(aurora + orbes drift; preset `.hoy`) · `LiquidVeil` · `LiquidScreenHeader` · `LiquidDialSeal`
(24 h: noche índigo, día tinta, marcador verde) · `LiquidSignalCables` · `LiquidHeroVeredicto`.
