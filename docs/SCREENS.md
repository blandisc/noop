...
**Secciones:** Recuperación (fila héroe destacada, en `surface`) · Descanso & carga (Sueño · Esfuerzo del día · Estrés) · Vitales (HRV · FC en reposo · SpO₂ · Frecuencia cardíaca · Respiración · Temp. de piel) · Actividad (Pasos · Entrenamientos · **«Cómo amaneces tras cada deporte»** — mini-bloque Activity Cost, FER-139) · Longevidad (**Edad física** — número + delta vs edad, FER-141 · **Edad corporal** — Vitality/Body Age, FER-145 · **VO₂ máx** — fila Apple Salud que abre el Detalle de Métrica, FER-257) · acciones al pie (Comparar · Ver todas las métricas).
