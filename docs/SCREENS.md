...
**Componentes:** `HealthAlertBanner`, `PaperBackground` (lienzo de papel por hora, FER-135), `DiurnalDial` (dial 24h del héroe, FER-135), `importedBaselineHero` (base lista por Apple Health, FER-106), `CalibrationProgressCard`, `LiveHeartbeatRow`, `WhyVerdictSheet`, `MetricRow` (Métricas clave iOS con banda p25–p75 + color por métrica; incl. **Frecuencia cardíaca** → sheet de curva 24h, FER-137) · macOS (heredado): `RecoveryRing`, `StatTile ×10`, `ChartCard (HR Trend)`, `SourcesSummaryCard`, `ReadinessGaugeBar`, `readinessSection`  
