...
**Componentes:** `HealthAlertBanner`, `PaperBackground` (lienzo de papel por hora, FER-135), `heroInstrument` (héroe unificado de 4 modos vía `HeroState`, FER-160), `DiurnalDial` (dial 24h del héroe, FER-135), `LiveHeartbeatRow`, `WhyVerdictSheet`, `TodayMetricTile`/`TileButtonStyle` (rejilla «Métricas de hoy» 2×4, valor + Δ vs ayer, FER-180), `iosSourcesSection`/`sourceRow` (carta "Fuentes" al fondo, FER-164) · macOS (heredado): `MetricRow`, `RecoveryRing`, `StatTile ×10`, `ChartCard (HR Trend)`, `SourcesSummaryCard`, `ReadinessGaugeBar`, `readinessSection`  
