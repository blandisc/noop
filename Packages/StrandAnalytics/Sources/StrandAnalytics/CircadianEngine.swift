...
//     recover amplitude + phase. Method: Cornelissen, "Cosinor-based rhythmometry", Theoretical Biology
//     and Medical Modelling 2014;11:16. The accelerometer rest-activity rhythm is the primary phase
//     signal; the nightly skin-temperature minimum corroborates it (wrist skin temperature runs broadly
//     ANTI-phase to core temperature, and the core-body-temperature minimum, CBTmin, is the canonical
//     phase marker sitting ~2–3 h before habitual wake).
//   • Phase-response-curve (PRC) DIRECTION rule for the advisory: to ADVANCE the clock (eastward travel /
//     an earlier shift) → bright light in the morning (after CBTmin), dim evenings, earlier sleep, stepped
//     ~1 h/day; to DELAY (westward / a later shift) → bright light in the evening (before CBTmin), the
//     reverse. Direction verified against Khalsa et al., "A phase response curve to single bright light
//     pulses in human subjects", Journal of Physiology 2003;549(3):945–952.
//
