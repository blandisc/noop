...
//
// SCOPE OF THIS ENGINE (deliberately narrow):
...
//   screening verdict is HELD by design and is gated behind a separate go/no-go + the
//   consent machinery — it is not part of this code.
//
...
public enum RhythmScreener {
    ...
    // MARK: - Night-persistence thresholds (descriptive aggregation only)
    //
