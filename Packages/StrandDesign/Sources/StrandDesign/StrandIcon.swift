...
#Preview("Icons") {
    let all: [StrandIcon] = [.disclosure, .back, .close, .confirm, .add, .more, .info, .warning, .search, .up, .down, .heart, .sleep, .flame, .experiment, .clock, .calendar]
