...
//
// Sin dependencias, como el resto de StrandDesign: las ventanas de sol y sueño se INYECTAN, nunca se
...
/// `SolarWindow` carries sunrise/sunset. Keeping it a plain value keeps `StrandDesign` the
