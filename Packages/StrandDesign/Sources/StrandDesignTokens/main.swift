...
public let catalogEntries: [CatalogEntry] = [
    ...
    CatalogEntry(rol: "Botón pill Liquid", simbolo: "LiquidGlassButton",
                 ...
                 cuandoNo: "No para CTA de tinta a lo ancho en flujo Instrumento/Entrenar (usa `StrandCTAButton`); no `.plain` sin press."),
    CatalogEntry(rol: "Botón pastilla sólida", simbolo: "LiquidGlassButton(.solida)",
                 ...
                 cuandoNo: "No cuando quieras vidrio translúcido (usa `.glass`); no CTA a lo ancho (usa `StrandCTAButton`); no acción destructiva (`.destructive`)."),
    ...
    CatalogEntry(rol: "CTA de tinta (barra)", simbolo: "StrandCTAButton",
                 archivo: "StrandCTAButton.swift",
