...
enum MatrizDither {
    ...
    static func semilla(chartID: String, index: Int) -> UInt64 {
    ...
    static func particula(_ semilla: UInt64) -> (dScale: Double, dAlpha: Double, dx: Double, dy: Double) {
        var s = semilla
