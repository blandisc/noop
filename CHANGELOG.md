...
- **Detalle de Sueño: tendencia igual que en Hoy y nueva gráfica de deuda / Sleep detail: trend matches Today, new debt chart.**
  **ES** — En la hoja de **Sueño** (en Cuerpo) la gráfica de **tendencia de duración** ahora es **idéntica a la de Hoy**: 14 noches con las cuatro bandas (Corto / Adecuado / Óptimo 7–9 h / Extendido), la banda donde caes resaltada y un encabezado que dice cuántas de tus últimas noches están en ese rango. Y la **deuda de sueño de la semana** dejó de ser una línea de texto: es su propio bloque, con el total acumulado como número grande y, debajo, una **barra por noche** que muestra cuál noche se quedó corta (hacia abajo) o superó tu necesidad (hacia arriba).
  **EN** — In the **Sleep** sheet (in Body) the **duration trend** chart now **matches the one in Today**: 14 nights with the four bands (Short / Adequate / Optimal 7–9 h / Extended), your current band highlighted and a header telling you how many of your recent nights sit in that range. And the week's **sleep debt** is no longer a text line: it's its own block, with the running total as a big number and, below it, **one bar per night** showing which night fell short (downward) or beat your need (upward).
